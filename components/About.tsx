import { coffee } from "@/public/assets";
...
const About = () => {
  return (
    <section
      id="about"
      className="w-full max-w-contentContainer bg-blackGrey flex justify-center px-6 scroll-mt-20"
    >
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 rounded-lg bg-darkGrey overflow-hidden relative">
        ...
        <div className="w-full flex flex-col justify-center items-center px-4 py-6">
          ...
          <p className="text-xs font-titleFont text-offWhite leading-relaxed text-center mt-2 mb-4">
            Cuba Bakery is more than just a bakery—it&#39;s the story of a
            family&#39;s journey, resilience, and love for tradition. Our story
            began in 1972, when our family, filled with hope and dreams for a
            new life, opened our first bakery in New Jersey after leaving Cuba.
            Fueled by a passion for preserving our heritage, we brought the rich
            flavors of Cuba to the community. Years later, we brought our roots
            further south to Miami, where Cuba Bakery continues to thrive as a
          ...
          <p className="text-xs font-titleFont text-offWhite leading-relaxed text-center mb-2">
            Today, we proudly offer a taste of home with our authentic Cuban
            pastries, savory dishes, and handcrafted cakes, while staying true
            to the recipes and traditions that started it all.
          </p>
